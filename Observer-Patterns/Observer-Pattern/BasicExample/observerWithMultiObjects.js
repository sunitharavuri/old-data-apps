///In order not to create multiple observable objects 
// it is much better to add topic functionality to Observer pattern
...
var Observable = {
  ...
  , removeObserver: function(topic, observer) {//adding topic
